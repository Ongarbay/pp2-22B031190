...
pygame.display.set_icon(pygame.image.load("paint-icon.png"))
...
def control_panel():
    ...
    image_of_rectangle = pygame.image.load("rectangle.png")
    image_of_circle = pygame.image.load("circle.png")
    image_of_ellipse = pygame.image.load("ellipse.png")
    image_of_line = pygame.image.load("line.png")
    image_of_palette = pygame.image.load("palette.png")
